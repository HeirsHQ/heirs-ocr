...
const Shimmer = ({ className, style }: { className?: string; style?: CSSProperties }) => (
  <div
    className={cn(
      "relative overflow-hidden rounded-xs bg-(--surface-strong)",
      "before:absolute before:inset-0 before:-translate-x-full",
      "before:bg-linear-to-r before:from-transparent before:via-[rgba(255,255,255,0.55)] before:to-transparent",
...
const TableSkeleton = ({ columns = 6, rows = 8 }: { columns?: number; rows?: number }) => {
  ...
  return (
    <div className="bg-card border-hairline w-full overflow-hidden rounded-xs border">
      <div className="border-hairline flex h-11 items-center gap-4 border-b bg-(--surface-strong) px-4">
